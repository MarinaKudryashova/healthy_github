...
document.addEventListener('DOMContentLoaded', event => {
  ...
  // const blogsSlider = document.querySelector('.blog__slider');
  ...
  // if(blogsSlider) {
  //   const swiper_blogsSlider = new Swiper(blogsSlider, {
  //     loop: true,
  //     lazy: true,
  //     slidesPerView: 1.3,
  //     spaceBetween: 70,
  ...
  // }
  // if(reviewsSlider) {
  //   const swiper_reviewsSlider = new Swiper(reviewsSlider, {
  //     loop: true,
  //     lazy: true,
  //     slidesPerView: 1.1,
  //     spaceBetween: 20,
